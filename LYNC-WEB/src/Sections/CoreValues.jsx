    ...
    <section className="w-full py-2 pb-12">
      <div className="max-w-[1180px] mx-auto px-10">
        <div className="flex lg:flex-row flex-col gap-6 items-stretch">
          ...
          <div className="flex-shrink-0 lg:w-[314px]  w-[260px] bg-[#221e57]/14 rounded-2xl p-6 flex flex-col gap-3 shadow-sm">
            <h2 className="text-[3rem] lg:text-[2rem] text-accent font-bold text-center mb-2">
              Our Core Values
            </h2>
